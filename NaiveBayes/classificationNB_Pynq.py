...
class Naivebayes(object):
    ...
    def train(self, trainRDD, _accel_ = 0):  
        ...
        if (_accel_):
            ...
            self.trainPack = list(trainPackage)
            # print(self.trainPack[2][:])
        # end = time() 
        print("! Time running Naive Bayes in function in harware: {:.3f} sec".format(end - start))
    ...
    def predict(self, data):
        ...
        prediction = 0     
        max_likelihood = -inf
        # print(self.trainPack)
        # numerator = log(self.trainPack[2][1])
